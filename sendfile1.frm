...
Begin VB.Form sendfile1 
   ...
   Begin VB.TextBox thename 
      ...
      Width           =   495
   End
   Begin VB.TextBox HandleWhatFile 
      Height          =   285
      Left            =   960
      TabIndex        =   7
      Top             =   2520
...
AddStat "Connecting"
Winsock1.Close
Winsock1.Connect Form1.Uploader(HandleWhatFile).RemoteHostIP
